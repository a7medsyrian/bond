...
async def compress(event):
    ...
    try:
        ...
        print(e)
        return await edit.edit(f"💢 **AN ERROR OCCURRED WHILE DOWNLOADING**", link_preview=False)
    ...
    try:
        ...
        print(e)
        return await edit.edit(f"💢AN ERROR OCCURRED WHILE **FFMPEG** PROGRESS", link_preview=False)
    ...
    if db.original:
        ...
        thumb = Config.Thumb
    try:
        uploader = await fast_upload(out_path, file_name, time(), bot, edit, '**UPLOADING**')
        if db.doc:
        ...
        print(e)
        return await edit.edit(f"💢 **AN ERROR OCCURRED WHILE UPLOADING**", link_preview=False)
